...
class Color:
  ...
  def __GetR(self):
    return self.__rgb[0]
  r = property(fget=__GetR, doc='The red component of the RGB representation of this color.')

  def __GetG(self):
    return self.__rgb[1]
  g = property(fget=__GetG, doc='The green component of the RGB representation of this color.')

  def __GetB(self):
    return self.__rgb[2]
  b = property(fget=__GetB, doc='The blue component of the RGB representation of this color.')
